...
<div class="container">
      <form action="includes/create.php" method="post">
         ...
         <div class="mb-3">
            ...
            <textarea name = "description" class="form-control" id="text" rows = "5" placeholder="Enter the note's description"></textarea>
         </div>
   ...
   <?php foreach($notes as $note) { ?>
      <div style='padding: 10px' class='card mt-5 mb-5'>
         ...
         <form action="includes/edit.php" method="post">
               <button style="margin-left: 10px" type="submit" class='btn btn-primary' name='id' value=<?php echo $note['id'] ?>>EDIT</button>
         </form>
